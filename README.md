...
- **Settings panel** — account avatar menu + manager menu: card style (Standard / FIFA / Neon), version, hovercard injection, cache stats / remaining space, cache duration, clear cache
