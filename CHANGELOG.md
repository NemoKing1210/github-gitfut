...
- Language setting in the settings panel: Auto (browser) or any of the 10 UI locales; changing language reloads the page

## [1.8.0] - 2026-07-16

### Added

- **GitHub** card style: Primer tokens, flat borders, muted OVR counter, no glow / shine / pulse — blends with the site UI
